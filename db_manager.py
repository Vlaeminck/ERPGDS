...
def init_db(seed_samples=False):
    ...
    try:
        ...
        pass
    try:
        cursor.execute("ALTER TABLE proveedores ADD COLUMN subcategoria TEXT DEFAULT ''")
    except Exception:
        pass
    try:
        cursor.execute("ALTER TABLE proveedores ADD COLUMN is_deleted INTEGER DEFAULT 0")
    except Exception:
        pass
